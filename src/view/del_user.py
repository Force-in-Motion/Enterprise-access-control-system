...
from settings.config_del_user import *



class DelUserFrame(ctk.CTkFrame):
    """
    Класс- контейнер, содержащий в себе все остальные виджеты и элементы страницы
    """
    def __init__(self, main_page: DelUser, *args, **kwargs):
    ...
    def __config_label(self) -> None:
        ...
        self.__add_user.place(relx=0.27, rely=0.12)
    ...
    def __config_inputs(self) -> None:
        ...
        self.__input_name.place(relx=0.18, rely=0.3)
    ...
    def __config_menu_btn(self) -> None:
        ...
        :return: None
        """
        self.__del_btn = ctk.CTkButton(self, width=ad_wh, height=ad_ht, text=ad_tt, font=ad_ft,
                                         text_color=ad_ttc, fg_color=ad_fgc)
        self.__del_btn.place(relx=0.19, rely=0.51)
        ...
        self.__cancel_btn.place(relx=0.59, rely=0.51)
...
class DelUser(ctk.CTkToplevel):
    ...
    def __config_frame(self) -> None:
        """
        Формирует мэйн фрейм главной страницы модуля, содержащий остальные элементы и виджеты страницы
        :return: None
        """
        self.__main_frame = DelUserFrame(self, master=self, width=fr_wh, height=fr_ht)
    ...
    def on_del_click(self) -> None:
        ...
        :return: None
        """
        self.__controller.del_user_button_click_handler(self.__main_frame.name.get())
